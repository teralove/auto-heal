...
- Default is on
### `autocleanse [on/off]`
- Enable/disable auto-cleansing

## Issues
- Skills can ghost if proxy is also using Skill-Prediction (You see animation but nothing happens). [Click here for workaround.](https://i.imgur.com/bS4VkbX.png)
